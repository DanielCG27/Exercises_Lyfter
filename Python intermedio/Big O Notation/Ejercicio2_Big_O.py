def print_numbers_times_2(numbers_list):
	for number in numbers_list: # O(n)
		print(number * 2) # O(1)
# La complejidad del algoritmo analizado es O(n)		
...
# La complejidad del algoritmo analizado es O(n^3)